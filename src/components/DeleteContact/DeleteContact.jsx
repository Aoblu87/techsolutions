  ...
  return (
    <>
      <button
        ...
        className={`${active ? activeClass : noActiveClass} hover:bg-subdue hover:text-neutral  ${customClass}`}
      >
        Delete
      </button>
        ...
        <div className="fixed inset-0 flex justify-center items-center">
          <div className="bg-neutral p-6 rounded-lg shadow-md w-72">
            <div className="flex justify-between items-center">
              <p className="text-lg font-semibold text-subdue">Deleted</p>
              <button onClick={handleCardClose} className="focus:outline-none">
                <svg
